                ...
                <div class="row">
                    <div class="col-lg">                       
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Responsive single page website with Parallax effect</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="projects/parallax" target="_blank" class="badge badge-success">Click here</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </ul>
                        ...
                        <ul class="list-group list-group-item group-bg">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th scope="row">URL</th>
                                        <td><code>https://fonts.googleapis.com/css?family=Montserrat:400,700</code></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Family</th>
                                        <td><code>font-family: 'Montserrat', sans-serif;</code></td>
                                    </tr>
                                </tbody>
                            </table>
                        </ul>
                        ...
                        <ul class="list-group list-group-item group-bg">
                            ...
                            listFolderFiles('projects/parallax');
                            ?>
                        </ul>
                        <hr class="light">
                        <i class="fa fa-download" aria-hidden="true"></i> <a class="dload" href="downloads/parallax.zip">Download parallax.zip</a>
                    </div>
                </div>
            </section>
