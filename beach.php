                ...
                <div class="row">
                    <div class="col-lg">                       
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Responsive full viewport landing page with JQuery smooth scroll</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="projects/beach" target="_blank" class="badge badge-success">Click here</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </ul>
                        ...
                        <ul class="list-group list-group-item group-bg">
                            ...
                            listFolderFiles('projects/beach');
                            ?>
                        </ul>
                        <hr class="light">
                        <i class="fa fa-download" aria-hidden="true"></i> <a class="dload" href="downloads/beach.zip">Download beach.zip</a>
                    </div>
                </div>
            </section>
